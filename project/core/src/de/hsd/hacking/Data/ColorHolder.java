...
public class ColorHolder {
    ...
    public static String Trousers = "404040ff";
    public static String Shoes = "2d2d2dff";
    public static String Shirt = "717171ff";
    public static String Skin = "2d2d2dff";
    public static String Eyes = "7c7c7cff";
    public static String Hair = "969696ff";
